...
`timescale 1 ps / 1 ps
module elc3_soc_mm_interconnect_0 (
		...
		output wire [11:0] char_buffer_s1_address,                             //                               char_buffer_s1.address
		output wire        char_buffer_s1_write,                               //                                             .write
		input  wire [7:0]  char_buffer_s1_readdata,                            //                                             .readdata
		output wire [7:0]  char_buffer_s1_writedata,                           //                                             .writedata
		output wire        char_buffer_s1_chipselect,                          //                                             .chipselect
		output wire        char_buffer_s1_clken,                               //                                             .clken
		...
		output wire [9:0]  nios_onchipmem_s1_address,                          //                            nios_onchipmem_s1.address
		output wire        nios_onchipmem_s1_write,                            //                                             .write
		input  wire [31:0] nios_onchipmem_s1_readdata,                         //                                             .readdata
		output wire [31:0] nios_onchipmem_s1_writedata,                        //                                             .writedata
		output wire [3:0]  nios_onchipmem_s1_byteenable,                       //                                             .byteenable
		output wire        nios_onchipmem_s1_chipselect,                       //                                             .chipselect
		output wire        nios_onchipmem_s1_clken,                            //                                             .clken
	...
	wire   [31:0] nios_onchipmem_s1_agent_m0_readdata;                                                // nios_onchipmem_s1_translator:uav_readdata -> nios_onchipmem_s1_agent:m0_readdata
	wire          nios_onchipmem_s1_agent_m0_waitrequest;                                             // nios_onchipmem_s1_translator:uav_waitrequest -> nios_onchipmem_s1_agent:m0_waitrequest
	wire          nios_onchipmem_s1_agent_m0_debugaccess;                                             // nios_onchipmem_s1_agent:m0_debugaccess -> nios_onchipmem_s1_translator:uav_debugaccess
	wire   [28:0] nios_onchipmem_s1_agent_m0_address;                                                 // nios_onchipmem_s1_agent:m0_address -> nios_onchipmem_s1_translator:uav_address
	wire    [3:0] nios_onchipmem_s1_agent_m0_byteenable;                                              // nios_onchipmem_s1_agent:m0_byteenable -> nios_onchipmem_s1_translator:uav_byteenable
	wire          nios_onchipmem_s1_agent_m0_read;                                                    // nios_onchipmem_s1_agent:m0_read -> nios_onchipmem_s1_translator:uav_read
	wire          nios_onchipmem_s1_agent_m0_readdatavalid;                                           // nios_onchipmem_s1_translator:uav_readdatavalid -> nios_onchipmem_s1_agent:m0_readdatavalid
	wire          nios_onchipmem_s1_agent_m0_lock;                                                    // nios_onchipmem_s1_agent:m0_lock -> nios_onchipmem_s1_translator:uav_lock
	wire   [31:0] nios_onchipmem_s1_agent_m0_writedata;                                               // nios_onchipmem_s1_agent:m0_writedata -> nios_onchipmem_s1_translator:uav_writedata
	wire          nios_onchipmem_s1_agent_m0_write;                                                   // nios_onchipmem_s1_agent:m0_write -> nios_onchipmem_s1_translator:uav_write
	wire    [2:0] nios_onchipmem_s1_agent_m0_burstcount;                                              // nios_onchipmem_s1_agent:m0_burstcount -> nios_onchipmem_s1_translator:uav_burstcount
	wire          nios_onchipmem_s1_agent_rf_source_valid;                                            // nios_onchipmem_s1_agent:rf_source_valid -> nios_onchipmem_s1_agent_rsp_fifo:in_valid
	wire  [105:0] nios_onchipmem_s1_agent_rf_source_data;                                             // nios_onchipmem_s1_agent:rf_source_data -> nios_onchipmem_s1_agent_rsp_fifo:in_data
	wire          nios_onchipmem_s1_agent_rf_source_ready;                                            // nios_onchipmem_s1_agent_rsp_fifo:in_ready -> nios_onchipmem_s1_agent:rf_source_ready
	wire          nios_onchipmem_s1_agent_rf_source_startofpacket;                                    // nios_onchipmem_s1_agent:rf_source_startofpacket -> nios_onchipmem_s1_agent_rsp_fifo:in_startofpacket
	wire          nios_onchipmem_s1_agent_rf_source_endofpacket;                                      // nios_onchipmem_s1_agent:rf_source_endofpacket -> nios_onchipmem_s1_agent_rsp_fifo:in_endofpacket
	wire          nios_onchipmem_s1_agent_rsp_fifo_out_valid;                                         // nios_onchipmem_s1_agent_rsp_fifo:out_valid -> nios_onchipmem_s1_agent:rf_sink_valid
	wire  [105:0] nios_onchipmem_s1_agent_rsp_fifo_out_data;                                          // nios_onchipmem_s1_agent_rsp_fifo:out_data -> nios_onchipmem_s1_agent:rf_sink_data
	wire          nios_onchipmem_s1_agent_rsp_fifo_out_ready;                                         // nios_onchipmem_s1_agent:rf_sink_ready -> nios_onchipmem_s1_agent_rsp_fifo:out_ready
	wire          nios_onchipmem_s1_agent_rsp_fifo_out_startofpacket;                                 // nios_onchipmem_s1_agent_rsp_fifo:out_startofpacket -> nios_onchipmem_s1_agent:rf_sink_startofpacket
	wire          nios_onchipmem_s1_agent_rsp_fifo_out_endofpacket;                                   // nios_onchipmem_s1_agent_rsp_fifo:out_endofpacket -> nios_onchipmem_s1_agent:rf_sink_endofpacket
	wire          cmd_mux_003_src_valid;                                                              // cmd_mux_003:src_valid -> nios_onchipmem_s1_agent:cp_valid
	wire  [104:0] cmd_mux_003_src_data;                                                               // cmd_mux_003:src_data -> nios_onchipmem_s1_agent:cp_data
	wire          cmd_mux_003_src_ready;                                                              // nios_onchipmem_s1_agent:cp_ready -> cmd_mux_003:src_ready
	wire    [5:0] cmd_mux_003_src_channel;                                                            // cmd_mux_003:src_channel -> nios_onchipmem_s1_agent:cp_channel
	wire          cmd_mux_003_src_startofpacket;                                                      // cmd_mux_003:src_startofpacket -> nios_onchipmem_s1_agent:cp_startofpacket
	wire          cmd_mux_003_src_endofpacket;                                                        // cmd_mux_003:src_endofpacket -> nios_onchipmem_s1_agent:cp_endofpacket
	...
	wire   [33:0] sdram_controller_s1_agent_rdata_fifo_src_data;                                      // sdram_controller_s1_agent:rdata_fifo_src_data -> sdram_controller_s1_agent_rdata_fifo:in_data
	...
	wire          cmd_mux_004_src_valid;                                                              // cmd_mux_004:src_valid -> sdram_controller_s1_agent:cp_valid
	wire  [104:0] cmd_mux_004_src_data;                                                               // cmd_mux_004:src_data -> sdram_controller_s1_agent:cp_data
	wire          cmd_mux_004_src_ready;                                                              // sdram_controller_s1_agent:cp_ready -> cmd_mux_004:src_ready
	wire    [5:0] cmd_mux_004_src_channel;                                                            // cmd_mux_004:src_channel -> sdram_controller_s1_agent:cp_channel
	wire          cmd_mux_004_src_startofpacket;                                                      // cmd_mux_004:src_startofpacket -> sdram_controller_s1_agent:cp_startofpacket
	wire          cmd_mux_004_src_endofpacket;                                                        // cmd_mux_004:src_endofpacket -> sdram_controller_s1_agent:cp_endofpacket
	wire    [7:0] char_buffer_s1_agent_m0_readdata;                                                   // char_buffer_s1_translator:uav_readdata -> char_buffer_s1_agent:m0_readdata
	wire          char_buffer_s1_agent_m0_waitrequest;                                                // char_buffer_s1_translator:uav_waitrequest -> char_buffer_s1_agent:m0_waitrequest
	wire          char_buffer_s1_agent_m0_debugaccess;                                                // char_buffer_s1_agent:m0_debugaccess -> char_buffer_s1_translator:uav_debugaccess
	wire   [28:0] char_buffer_s1_agent_m0_address;                                                    // char_buffer_s1_agent:m0_address -> char_buffer_s1_translator:uav_address
	wire    [0:0] char_buffer_s1_agent_m0_byteenable;                                                 // char_buffer_s1_agent:m0_byteenable -> char_buffer_s1_translator:uav_byteenable
	wire          char_buffer_s1_agent_m0_read;                                                       // char_buffer_s1_agent:m0_read -> char_buffer_s1_translator:uav_read
	wire          char_buffer_s1_agent_m0_readdatavalid;                                              // char_buffer_s1_translator:uav_readdatavalid -> char_buffer_s1_agent:m0_readdatavalid
	wire          char_buffer_s1_agent_m0_lock;                                                       // char_buffer_s1_agent:m0_lock -> char_buffer_s1_translator:uav_lock
	wire    [7:0] char_buffer_s1_agent_m0_writedata;                                                  // char_buffer_s1_agent:m0_writedata -> char_buffer_s1_translator:uav_writedata
	wire          char_buffer_s1_agent_m0_write;                                                      // char_buffer_s1_agent:m0_write -> char_buffer_s1_translator:uav_write
	wire    [0:0] char_buffer_s1_agent_m0_burstcount;                                                 // char_buffer_s1_agent:m0_burstcount -> char_buffer_s1_translator:uav_burstcount
	wire          char_buffer_s1_agent_rf_source_valid;                                               // char_buffer_s1_agent:rf_source_valid -> char_buffer_s1_agent_rsp_fifo:in_valid
	wire   [78:0] char_buffer_s1_agent_rf_source_data;                                                // char_buffer_s1_agent:rf_source_data -> char_buffer_s1_agent_rsp_fifo:in_data
	wire          char_buffer_s1_agent_rf_source_ready;                                               // char_buffer_s1_agent_rsp_fifo:in_ready -> char_buffer_s1_agent:rf_source_ready
	wire          char_buffer_s1_agent_rf_source_startofpacket;                                       // char_buffer_s1_agent:rf_source_startofpacket -> char_buffer_s1_agent_rsp_fifo:in_startofpacket
	wire          char_buffer_s1_agent_rf_source_endofpacket;                                         // char_buffer_s1_agent:rf_source_endofpacket -> char_buffer_s1_agent_rsp_fifo:in_endofpacket
	wire          char_buffer_s1_agent_rsp_fifo_out_valid;                                            // char_buffer_s1_agent_rsp_fifo:out_valid -> char_buffer_s1_agent:rf_sink_valid
	wire   [78:0] char_buffer_s1_agent_rsp_fifo_out_data;                                             // char_buffer_s1_agent_rsp_fifo:out_data -> char_buffer_s1_agent:rf_sink_data
	wire          char_buffer_s1_agent_rsp_fifo_out_ready;                                            // char_buffer_s1_agent:rf_sink_ready -> char_buffer_s1_agent_rsp_fifo:out_ready
	wire          char_buffer_s1_agent_rsp_fifo_out_startofpacket;                                    // char_buffer_s1_agent_rsp_fifo:out_startofpacket -> char_buffer_s1_agent:rf_sink_startofpacket
	wire          char_buffer_s1_agent_rsp_fifo_out_endofpacket;                                      // char_buffer_s1_agent_rsp_fifo:out_endofpacket -> char_buffer_s1_agent:rf_sink_endofpacket
	...
	wire          nios_onchipmem_s1_agent_rp_valid;                                                   // nios_onchipmem_s1_agent:rp_valid -> router_005:sink_valid
	wire  [104:0] nios_onchipmem_s1_agent_rp_data;                                                    // nios_onchipmem_s1_agent:rp_data -> router_005:sink_data
	wire          nios_onchipmem_s1_agent_rp_ready;                                                   // router_005:sink_ready -> nios_onchipmem_s1_agent:rp_ready
	wire          nios_onchipmem_s1_agent_rp_startofpacket;                                           // nios_onchipmem_s1_agent:rp_startofpacket -> router_005:sink_startofpacket
	wire          nios_onchipmem_s1_agent_rp_endofpacket;                                             // nios_onchipmem_s1_agent:rp_endofpacket -> router_005:sink_endofpacket
	...
	wire  [104:0] sdram_controller_s1_agent_rp_data;                                                  // sdram_controller_s1_agent:rp_data -> router_006:sink_data
	...
	wire          char_buffer_s1_agent_rp_valid;                                                      // char_buffer_s1_agent:rp_valid -> router_007:sink_valid
	wire   [77:0] char_buffer_s1_agent_rp_data;                                                       // char_buffer_s1_agent:rp_data -> router_007:sink_data
	wire          char_buffer_s1_agent_rp_ready;                                                      // router_007:sink_ready -> char_buffer_s1_agent:rp_ready
	wire          char_buffer_s1_agent_rp_startofpacket;                                              // char_buffer_s1_agent:rp_startofpacket -> router_007:sink_startofpacket
	wire          char_buffer_s1_agent_rp_endofpacket;                                                // char_buffer_s1_agent:rp_endofpacket -> router_007:sink_endofpacket
	wire          router_src_valid;                                                                   // router:src_valid -> nios2_qsys_0_data_master_limiter:cmd_sink_valid
	wire  [104:0] router_src_data;                                                                    // router:src_data -> nios2_qsys_0_data_master_limiter:cmd_sink_data
	...
	wire  [104:0] nios2_qsys_0_data_master_limiter_cmd_src_data;                                      // nios2_qsys_0_data_master_limiter:cmd_src_data -> cmd_demux:sink_data
	...
	wire  [104:0] rsp_mux_src_data;                                                                   // rsp_mux:src_data -> nios2_qsys_0_data_master_limiter:rsp_sink_data
	...
	wire  [104:0] nios2_qsys_0_data_master_limiter_rsp_src_data;                                      // nios2_qsys_0_data_master_limiter:rsp_src_data -> nios2_qsys_0_data_master_agent:rp_data
	...
	wire  [104:0] router_001_src_data;                                                                // router_001:src_data -> nios2_qsys_0_instruction_master_limiter:cmd_sink_data
	...
	wire  [104:0] nios2_qsys_0_instruction_master_limiter_cmd_src_data;                               // nios2_qsys_0_instruction_master_limiter:cmd_src_data -> cmd_demux_001:sink_data
	...
	wire  [104:0] rsp_mux_001_src_data;                                                               // rsp_mux_001:src_data -> nios2_qsys_0_instruction_master_limiter:rsp_sink_data
	...
	wire  [104:0] nios2_qsys_0_instruction_master_limiter_rsp_src_data;                               // nios2_qsys_0_instruction_master_limiter:rsp_src_data -> nios2_qsys_0_instruction_master_agent:rp_data
	...
	wire          char_buffer_s1_burst_adapter_source0_valid;                                         // char_buffer_s1_burst_adapter:source0_valid -> char_buffer_s1_agent:cp_valid
	wire   [77:0] char_buffer_s1_burst_adapter_source0_data;                                          // char_buffer_s1_burst_adapter:source0_data -> char_buffer_s1_agent:cp_data
	wire          char_buffer_s1_burst_adapter_source0_ready;                                         // char_buffer_s1_agent:cp_ready -> char_buffer_s1_burst_adapter:source0_ready
	wire    [5:0] char_buffer_s1_burst_adapter_source0_channel;                                       // char_buffer_s1_burst_adapter:source0_channel -> char_buffer_s1_agent:cp_channel
	wire          char_buffer_s1_burst_adapter_source0_startofpacket;                                 // char_buffer_s1_burst_adapter:source0_startofpacket -> char_buffer_s1_agent:cp_startofpacket
	wire          char_buffer_s1_burst_adapter_source0_endofpacket;                                   // char_buffer_s1_burst_adapter:source0_endofpacket -> char_buffer_s1_agent:cp_endofpacket
	...
	wire          router_007_src_valid;                                                               // router_007:src_valid -> char_buffer_s1_rsp_width_adapter:in_valid
	wire   [77:0] router_007_src_data;                                                                // router_007:src_data -> char_buffer_s1_rsp_width_adapter:in_data
	wire          router_007_src_ready;                                                               // char_buffer_s1_rsp_width_adapter:in_ready -> router_007:src_ready
	wire    [5:0] router_007_src_channel;                                                             // router_007:src_channel -> char_buffer_s1_rsp_width_adapter:in_channel
	wire          router_007_src_startofpacket;                                                       // router_007:src_startofpacket -> char_buffer_s1_rsp_width_adapter:in_startofpacket
	wire          router_007_src_endofpacket;                                                         // router_007:src_endofpacket -> char_buffer_s1_rsp_width_adapter:in_endofpacket
	wire          char_buffer_s1_rsp_width_adapter_src_valid;                                         // char_buffer_s1_rsp_width_adapter:out_valid -> rsp_demux_005:sink_valid
	wire  [104:0] char_buffer_s1_rsp_width_adapter_src_data;                                          // char_buffer_s1_rsp_width_adapter:out_data -> rsp_demux_005:sink_data
	wire          char_buffer_s1_rsp_width_adapter_src_ready;                                         // rsp_demux_005:sink_ready -> char_buffer_s1_rsp_width_adapter:out_ready
	wire    [5:0] char_buffer_s1_rsp_width_adapter_src_channel;                                       // char_buffer_s1_rsp_width_adapter:out_channel -> rsp_demux_005:sink_channel
	wire          char_buffer_s1_rsp_width_adapter_src_startofpacket;                                 // char_buffer_s1_rsp_width_adapter:out_startofpacket -> rsp_demux_005:sink_startofpacket
	wire          char_buffer_s1_rsp_width_adapter_src_endofpacket;                                   // char_buffer_s1_rsp_width_adapter:out_endofpacket -> rsp_demux_005:sink_endofpacket
	wire          cmd_mux_005_src_valid;                                                              // cmd_mux_005:src_valid -> char_buffer_s1_cmd_width_adapter:in_valid
	wire  [104:0] cmd_mux_005_src_data;                                                               // cmd_mux_005:src_data -> char_buffer_s1_cmd_width_adapter:in_data
	wire          cmd_mux_005_src_ready;                                                              // char_buffer_s1_cmd_width_adapter:in_ready -> cmd_mux_005:src_ready
	wire    [5:0] cmd_mux_005_src_channel;                                                            // cmd_mux_005:src_channel -> char_buffer_s1_cmd_width_adapter:in_channel
	wire          cmd_mux_005_src_startofpacket;                                                      // cmd_mux_005:src_startofpacket -> char_buffer_s1_cmd_width_adapter:in_startofpacket
	wire          cmd_mux_005_src_endofpacket;                                                        // cmd_mux_005:src_endofpacket -> char_buffer_s1_cmd_width_adapter:in_endofpacket
	wire          char_buffer_s1_cmd_width_adapter_src_valid;                                         // char_buffer_s1_cmd_width_adapter:out_valid -> char_buffer_s1_burst_adapter:sink0_valid
	wire   [77:0] char_buffer_s1_cmd_width_adapter_src_data;                                          // char_buffer_s1_cmd_width_adapter:out_data -> char_buffer_s1_burst_adapter:sink0_data
	wire          char_buffer_s1_cmd_width_adapter_src_ready;                                         // char_buffer_s1_burst_adapter:sink0_ready -> char_buffer_s1_cmd_width_adapter:out_ready
	wire    [5:0] char_buffer_s1_cmd_width_adapter_src_channel;                                       // char_buffer_s1_cmd_width_adapter:out_channel -> char_buffer_s1_burst_adapter:sink0_channel
	wire          char_buffer_s1_cmd_width_adapter_src_startofpacket;                                 // char_buffer_s1_cmd_width_adapter:out_startofpacket -> char_buffer_s1_burst_adapter:sink0_startofpacket
	wire          char_buffer_s1_cmd_width_adapter_src_endofpacket;                                   // char_buffer_s1_cmd_width_adapter:out_endofpacket -> char_buffer_s1_burst_adapter:sink0_endofpacket
	...
	wire          nios_onchipmem_s1_agent_rdata_fifo_src_valid;                                       // nios_onchipmem_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_003:in_0_valid
	wire   [33:0] nios_onchipmem_s1_agent_rdata_fifo_src_data;                                        // nios_onchipmem_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_003:in_0_data
	wire          nios_onchipmem_s1_agent_rdata_fifo_src_ready;                                       // avalon_st_adapter_003:in_0_ready -> nios_onchipmem_s1_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_003_out_0_valid;                                                  // avalon_st_adapter_003:out_0_valid -> nios_onchipmem_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_003_out_0_data;                                                   // avalon_st_adapter_003:out_0_data -> nios_onchipmem_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_003_out_0_ready;                                                  // nios_onchipmem_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_003:out_0_ready
	wire    [0:0] avalon_st_adapter_003_out_0_error;                                                  // avalon_st_adapter_003:out_0_error -> nios_onchipmem_s1_agent:rdata_fifo_sink_error
	...
	wire   [33:0] sdram_controller_s1_agent_rdata_fifo_out_data;                                      // sdram_controller_s1_agent_rdata_fifo:out_data -> avalon_st_adapter_004:in_0_data
	...
	wire   [33:0] avalon_st_adapter_004_out_0_data;                                                   // avalon_st_adapter_004:out_0_data -> sdram_controller_s1_agent:rdata_fifo_sink_data
	...
	wire          char_buffer_s1_agent_rdata_fifo_src_valid;                                          // char_buffer_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_005:in_0_valid
	wire    [9:0] char_buffer_s1_agent_rdata_fifo_src_data;                                           // char_buffer_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_005:in_0_data
	wire          char_buffer_s1_agent_rdata_fifo_src_ready;                                          // avalon_st_adapter_005:in_0_ready -> char_buffer_s1_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_005_out_0_valid;                                                  // avalon_st_adapter_005:out_0_valid -> char_buffer_s1_agent:rdata_fifo_sink_valid
	wire    [9:0] avalon_st_adapter_005_out_0_data;                                                   // avalon_st_adapter_005:out_0_data -> char_buffer_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_005_out_0_ready;                                                  // char_buffer_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_005:out_0_ready
	wire    [0:0] avalon_st_adapter_005_out_0_error;                                                  // avalon_st_adapter_005:out_0_error -> char_buffer_s1_agent:rdata_fifo_sink_error
	...
	altera_merlin_slave_translator #(
		...
		.AV_SETUP_WAIT_CYCLES           (0),
		.AV_DATA_HOLD_CYCLES            (0)
	) nios_onchipmem_s1_translator (
		.clk                    (clk_0_clk_clk),                                    //                      clk.clk
		.reset                  (nios2_qsys_0_reset_n_reset_bridge_in_reset_reset), //                    reset.reset
		.uav_address            (nios_onchipmem_s1_agent_m0_address),               // avalon_universal_slave_0.address
		.uav_burstcount         (nios_onchipmem_s1_agent_m0_burstcount),            //                         .burstcount
		.uav_read               (nios_onchipmem_s1_agent_m0_read),                  //                         .read
		.uav_write              (nios_onchipmem_s1_agent_m0_write),                 //                         .write
		.uav_waitrequest        (nios_onchipmem_s1_agent_m0_waitrequest),           //                         .waitrequest
		.uav_readdatavalid      (nios_onchipmem_s1_agent_m0_readdatavalid),         //                         .readdatavalid
		.uav_byteenable         (nios_onchipmem_s1_agent_m0_byteenable),            //                         .byteenable
		.uav_readdata           (nios_onchipmem_s1_agent_m0_readdata),              //                         .readdata
		.uav_writedata          (nios_onchipmem_s1_agent_m0_writedata),             //                         .writedata
		.uav_lock               (nios_onchipmem_s1_agent_m0_lock),                  //                         .lock
		.uav_debugaccess        (nios_onchipmem_s1_agent_m0_debugaccess),           //                         .debugaccess
		.av_address             (nios_onchipmem_s1_address),                        //      avalon_anti_slave_0.address
		.av_write               (nios_onchipmem_s1_write),                          //                         .write
		.av_readdata            (nios_onchipmem_s1_readdata),                       //                         .readdata
		.av_writedata           (nios_onchipmem_s1_writedata),                      //                         .writedata
		.av_byteenable          (nios_onchipmem_s1_byteenable),                     //                         .byteenable
		.av_chipselect          (nios_onchipmem_s1_chipselect),                     //                         .chipselect
		.av_clken               (nios_onchipmem_s1_clken),                          //                         .clken
		.av_read                (),                                                 //              (terminated)
		.av_begintransfer       (),                                                 //              (terminated)
		.av_beginbursttransfer  (),                                                 //              (terminated)
		.av_burstcount          (),                                                 //              (terminated)
	...
	altera_merlin_slave_translator #(
		...
		.AV_SETUP_WAIT_CYCLES           (0),
		.AV_DATA_HOLD_CYCLES            (0)
	) char_buffer_s1_translator (
		.clk                    (clk_0_clk_clk),                                    //                      clk.clk
		.reset                  (nios2_qsys_0_reset_n_reset_bridge_in_reset_reset), //                    reset.reset
		.uav_address            (char_buffer_s1_agent_m0_address),                  // avalon_universal_slave_0.address
		.uav_burstcount         (char_buffer_s1_agent_m0_burstcount),               //                         .burstcount
		.uav_read               (char_buffer_s1_agent_m0_read),                     //                         .read
		.uav_write              (char_buffer_s1_agent_m0_write),                    //                         .write
		.uav_waitrequest        (char_buffer_s1_agent_m0_waitrequest),              //                         .waitrequest
		.uav_readdatavalid      (char_buffer_s1_agent_m0_readdatavalid),            //                         .readdatavalid
		.uav_byteenable         (char_buffer_s1_agent_m0_byteenable),               //                         .byteenable
		.uav_readdata           (char_buffer_s1_agent_m0_readdata),                 //                         .readdata
		.uav_writedata          (char_buffer_s1_agent_m0_writedata),                //                         .writedata
		.uav_lock               (char_buffer_s1_agent_m0_lock),                     //                         .lock
		.uav_debugaccess        (char_buffer_s1_agent_m0_debugaccess),              //                         .debugaccess
		.av_address             (char_buffer_s1_address),                           //      avalon_anti_slave_0.address
		.av_write               (char_buffer_s1_write),                             //                         .write
		.av_readdata            (char_buffer_s1_readdata),                          //                         .readdata
		.av_writedata           (char_buffer_s1_writedata),                         //                         .writedata
		.av_chipselect          (char_buffer_s1_chipselect),                        //                         .chipselect
		.av_clken               (char_buffer_s1_clken),                             //                         .clken
		.av_read                (),                                                 //              (terminated)
		.av_begintransfer       (),                                                 //              (terminated)
		.av_beginbursttransfer  (),                                                 //              (terminated)
		.av_burstcount          (),                                                 //              (terminated)
	...
	altera_merlin_slave_agent #(
		...
		.USE_WRITERESPONSE         (0),
		.ECC_ENABLE                (0)
	) nios_onchipmem_s1_agent (
		.clk                     (clk_0_clk_clk),                                      //             clk.clk
		.reset                   (nios2_qsys_0_reset_n_reset_bridge_in_reset_reset),   //       clk_reset.reset
		.m0_address              (nios_onchipmem_s1_agent_m0_address),                 //              m0.address
		.m0_burstcount           (nios_onchipmem_s1_agent_m0_burstcount),              //                .burstcount
		.m0_byteenable           (nios_onchipmem_s1_agent_m0_byteenable),              //                .byteenable
		.m0_debugaccess          (nios_onchipmem_s1_agent_m0_debugaccess),             //                .debugaccess
		.m0_lock                 (nios_onchipmem_s1_agent_m0_lock),                    //                .lock
		.m0_readdata             (nios_onchipmem_s1_agent_m0_readdata),                //                .readdata
		.m0_readdatavalid        (nios_onchipmem_s1_agent_m0_readdatavalid),           //                .readdatavalid
		.m0_read                 (nios_onchipmem_s1_agent_m0_read),                    //                .read
		.m0_waitrequest          (nios_onchipmem_s1_agent_m0_waitrequest),             //                .waitrequest
		.m0_writedata            (nios_onchipmem_s1_agent_m0_writedata),               //                .writedata
		.m0_write                (nios_onchipmem_s1_agent_m0_write),                   //                .write
		.rp_endofpacket          (nios_onchipmem_s1_agent_rp_endofpacket),             //              rp.endofpacket
		.rp_ready                (nios_onchipmem_s1_agent_rp_ready),                   //                .ready
		.rp_valid                (nios_onchipmem_s1_agent_rp_valid),                   //                .valid
		.rp_data                 (nios_onchipmem_s1_agent_rp_data),                    //                .data
		.rp_startofpacket        (nios_onchipmem_s1_agent_rp_startofpacket),           //                .startofpacket
		...
		.rf_sink_ready           (nios_onchipmem_s1_agent_rsp_fifo_out_ready),         //         rf_sink.ready
		.rf_sink_valid           (nios_onchipmem_s1_agent_rsp_fifo_out_valid),         //                .valid
		.rf_sink_startofpacket   (nios_onchipmem_s1_agent_rsp_fifo_out_startofpacket), //                .startofpacket
		.rf_sink_endofpacket     (nios_onchipmem_s1_agent_rsp_fifo_out_endofpacket),   //                .endofpacket
		.rf_sink_data            (nios_onchipmem_s1_agent_rsp_fifo_out_data),          //                .data
		.rf_source_ready         (nios_onchipmem_s1_agent_rf_source_ready),            //       rf_source.ready
		.rf_source_valid         (nios_onchipmem_s1_agent_rf_source_valid),            //                .valid
		.rf_source_startofpacket (nios_onchipmem_s1_agent_rf_source_startofpacket),    //                .startofpacket
		.rf_source_endofpacket   (nios_onchipmem_s1_agent_rf_source_endofpacket),      //                .endofpacket
		.rf_source_data          (nios_onchipmem_s1_agent_rf_source_data),             //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_003_out_0_ready),                  // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_003_out_0_valid),                  //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_003_out_0_data),                   //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_003_out_0_error),                  //                .error
		.rdata_fifo_src_ready    (nios_onchipmem_s1_agent_rdata_fifo_src_ready),       //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (nios_onchipmem_s1_agent_rdata_fifo_src_valid),       //                .valid
		.rdata_fifo_src_data     (nios_onchipmem_s1_agent_rdata_fifo_src_data),        //                .data
		.m0_response             (2'b00),                                              //     (terminated)
		.m0_writeresponsevalid   (1'b0)                                                //     (terminated)
	);
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) nios_onchipmem_s1_agent_rsp_fifo (
		.clk               (clk_0_clk_clk),                                      //       clk.clk
		.reset             (nios2_qsys_0_reset_n_reset_bridge_in_reset_reset),   // clk_reset.reset
		.in_data           (nios_onchipmem_s1_agent_rf_source_data),             //        in.data
		.in_valid          (nios_onchipmem_s1_agent_rf_source_valid),            //          .valid
		.in_ready          (nios_onchipmem_s1_agent_rf_source_ready),            //          .ready
		.in_startofpacket  (nios_onchipmem_s1_agent_rf_source_startofpacket),    //          .startofpacket
		.in_endofpacket    (nios_onchipmem_s1_agent_rf_source_endofpacket),      //          .endofpacket
		.out_data          (nios_onchipmem_s1_agent_rsp_fifo_out_data),          //       out.data
		.out_valid         (nios_onchipmem_s1_agent_rsp_fifo_out_valid),         //          .valid
		.out_ready         (nios_onchipmem_s1_agent_rsp_fifo_out_ready),         //          .ready
		.out_startofpacket (nios_onchipmem_s1_agent_rsp_fifo_out_startofpacket), //          .startofpacket
		.out_endofpacket   (nios_onchipmem_s1_agent_rsp_fifo_out_endofpacket),   //          .endofpacket
		.csr_address       (2'b00),                                              // (terminated)
		.csr_read          (1'b0),                                               // (terminated)
		.csr_write         (1'b0),                                               // (terminated)
		.csr_readdata      (),                                                   // (terminated)
	...
	altera_merlin_slave_agent #(
		...
		.USE_WRITERESPONSE         (0),
		.ECC_ENABLE                (0)
	) char_buffer_s1_agent (
		.clk                     (clk_0_clk_clk),                                      //             clk.clk
		.reset                   (nios2_qsys_0_reset_n_reset_bridge_in_reset_reset),   //       clk_reset.reset
		.m0_address              (char_buffer_s1_agent_m0_address),                    //              m0.address
		.m0_burstcount           (char_buffer_s1_agent_m0_burstcount),                 //                .burstcount
		.m0_byteenable           (char_buffer_s1_agent_m0_byteenable),                 //                .byteenable
		.m0_debugaccess          (char_buffer_s1_agent_m0_debugaccess),                //                .debugaccess
		.m0_lock                 (char_buffer_s1_agent_m0_lock),                       //                .lock
		.m0_readdata             (char_buffer_s1_agent_m0_readdata),                   //                .readdata
		.m0_readdatavalid        (char_buffer_s1_agent_m0_readdatavalid),              //                .readdatavalid
		.m0_read                 (char_buffer_s1_agent_m0_read),                       //                .read
		.m0_waitrequest          (char_buffer_s1_agent_m0_waitrequest),                //                .waitrequest
		.m0_writedata            (char_buffer_s1_agent_m0_writedata),                  //                .writedata
		.m0_write                (char_buffer_s1_agent_m0_write),                      //                .write
		.rp_endofpacket          (char_buffer_s1_agent_rp_endofpacket),                //              rp.endofpacket
		.rp_ready                (char_buffer_s1_agent_rp_ready),                      //                .ready
		.rp_valid                (char_buffer_s1_agent_rp_valid),                      //                .valid
		.rp_data                 (char_buffer_s1_agent_rp_data),                       //                .data
		.rp_startofpacket        (char_buffer_s1_agent_rp_startofpacket),              //                .startofpacket
		.cp_ready                (char_buffer_s1_burst_adapter_source0_ready),         //              cp.ready
		.cp_valid                (char_buffer_s1_burst_adapter_source0_valid),         //                .valid
		.cp_data                 (char_buffer_s1_burst_adapter_source0_data),          //                .data
		.cp_startofpacket        (char_buffer_s1_burst_adapter_source0_startofpacket), //                .startofpacket
		.cp_endofpacket          (char_buffer_s1_burst_adapter_source0_endofpacket),   //                .endofpacket
		.cp_channel              (char_buffer_s1_burst_adapter_source0_channel),       //                .channel
		.rf_sink_ready           (char_buffer_s1_agent_rsp_fifo_out_ready),            //         rf_sink.ready
		.rf_sink_valid           (char_buffer_s1_agent_rsp_fifo_out_valid),            //                .valid
		.rf_sink_startofpacket   (char_buffer_s1_agent_rsp_fifo_out_startofpacket),    //                .startofpacket
		.rf_sink_endofpacket     (char_buffer_s1_agent_rsp_fifo_out_endofpacket),      //                .endofpacket
		.rf_sink_data            (char_buffer_s1_agent_rsp_fifo_out_data),             //                .data
		.rf_source_ready         (char_buffer_s1_agent_rf_source_ready),               //       rf_source.ready
		.rf_source_valid         (char_buffer_s1_agent_rf_source_valid),               //                .valid
		.rf_source_startofpacket (char_buffer_s1_agent_rf_source_startofpacket),       //                .startofpacket
		.rf_source_endofpacket   (char_buffer_s1_agent_rf_source_endofpacket),         //                .endofpacket
		.rf_source_data          (char_buffer_s1_agent_rf_source_data),                //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_005_out_0_ready),                  // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_005_out_0_valid),                  //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_005_out_0_data),                   //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_005_out_0_error),                  //                .error
		.rdata_fifo_src_ready    (char_buffer_s1_agent_rdata_fifo_src_ready),          //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (char_buffer_s1_agent_rdata_fifo_src_valid),          //                .valid
		.rdata_fifo_src_data     (char_buffer_s1_agent_rdata_fifo_src_data),           //                .data
		.m0_response             (2'b00),                                              //     (terminated)
		.m0_writeresponsevalid   (1'b0)                                                //     (terminated)
	);
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) char_buffer_s1_agent_rsp_fifo (
		.clk               (clk_0_clk_clk),                                    //       clk.clk
		.reset             (nios2_qsys_0_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
		.in_data           (char_buffer_s1_agent_rf_source_data),              //        in.data
		.in_valid          (char_buffer_s1_agent_rf_source_valid),             //          .valid
		.in_ready          (char_buffer_s1_agent_rf_source_ready),             //          .ready
		.in_startofpacket  (char_buffer_s1_agent_rf_source_startofpacket),     //          .startofpacket
		.in_endofpacket    (char_buffer_s1_agent_rf_source_endofpacket),       //          .endofpacket
		.out_data          (char_buffer_s1_agent_rsp_fifo_out_data),           //       out.data
		.out_valid         (char_buffer_s1_agent_rsp_fifo_out_valid),          //          .valid
		.out_ready         (char_buffer_s1_agent_rsp_fifo_out_ready),          //          .ready
		.out_startofpacket (char_buffer_s1_agent_rsp_fifo_out_startofpacket),  //          .startofpacket
		.out_endofpacket   (char_buffer_s1_agent_rsp_fifo_out_endofpacket),    //          .endofpacket
		.csr_address       (2'b00),                                            // (terminated)
		.csr_read          (1'b0),                                             // (terminated)
		.csr_write         (1'b0),                                             // (terminated)
		.csr_readdata      (),                                                 // (terminated)
	...
	elc3_soc_mm_interconnect_0_router router (
	...
	elc3_soc_mm_interconnect_0_router router_001 (
	...
	elc3_soc_mm_interconnect_0_router_002 router_002 (
	...
	elc3_soc_mm_interconnect_0_router_002 router_003 (
	...
	elc3_soc_mm_interconnect_0_router_002 router_004 (
	...
	elc3_soc_mm_interconnect_0_router_002 router_005 (
		.sink_ready         (nios_onchipmem_s1_agent_rp_ready),                 //      sink.ready
		.sink_valid         (nios_onchipmem_s1_agent_rp_valid),                 //          .valid
		.sink_data          (nios_onchipmem_s1_agent_rp_data),                  //          .data
		.sink_startofpacket (nios_onchipmem_s1_agent_rp_startofpacket),         //          .startofpacket
		.sink_endofpacket   (nios_onchipmem_s1_agent_rp_endofpacket),           //          .endofpacket
		.clk                (clk_0_clk_clk),                                    //       clk.clk
		.reset              (nios2_qsys_0_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	elc3_soc_mm_interconnect_0_router_002 router_006 (
	...
	elc3_soc_mm_interconnect_0_router_007 router_007 (
		.sink_ready         (char_buffer_s1_agent_rp_ready),                    //      sink.ready
		.sink_valid         (char_buffer_s1_agent_rp_valid),                    //          .valid
		.sink_data          (char_buffer_s1_agent_rp_data),                     //          .data
		.sink_startofpacket (char_buffer_s1_agent_rp_startofpacket),            //          .startofpacket
		.sink_endofpacket   (char_buffer_s1_agent_rp_endofpacket),              //          .endofpacket
		.clk                (clk_0_clk_clk),                                    //       clk.clk
		.reset              (nios2_qsys_0_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	) char_buffer_s1_burst_adapter (
		.clk                   (clk_0_clk_clk),                                      //       cr0.clk
		.reset                 (nios2_qsys_0_reset_n_reset_bridge_in_reset_reset),   // cr0_reset.reset
		.sink0_valid           (char_buffer_s1_cmd_width_adapter_src_valid),         //     sink0.valid
		.sink0_data            (char_buffer_s1_cmd_width_adapter_src_data),          //          .data
		.sink0_channel         (char_buffer_s1_cmd_width_adapter_src_channel),       //          .channel
		.sink0_startofpacket   (char_buffer_s1_cmd_width_adapter_src_startofpacket), //          .startofpacket
		.sink0_endofpacket     (char_buffer_s1_cmd_width_adapter_src_endofpacket),   //          .endofpacket
		.sink0_ready           (char_buffer_s1_cmd_width_adapter_src_ready),         //          .ready
		.source0_valid         (char_buffer_s1_burst_adapter_source0_valid),         //   source0.valid
		.source0_data          (char_buffer_s1_burst_adapter_source0_data),          //          .data
		.source0_channel       (char_buffer_s1_burst_adapter_source0_channel),       //          .channel
		.source0_startofpacket (char_buffer_s1_burst_adapter_source0_startofpacket), //          .startofpacket
		.source0_endofpacket   (char_buffer_s1_burst_adapter_source0_endofpacket),   //          .endofpacket
		.source0_ready         (char_buffer_s1_burst_adapter_source0_ready)          //          .ready
	);

	elc3_soc_mm_interconnect_0_cmd_demux cmd_demux (
		.clk                (clk_0_clk_clk),                                          //        clk.clk
		.reset              (nios2_qsys_0_reset_n_reset_bridge_in_reset_reset),       //  clk_reset.reset
	...
	elc3_soc_mm_interconnect_0_cmd_demux cmd_demux_001 (
		.clk                (clk_0_clk_clk),                                                 //        clk.clk
		.reset              (nios2_qsys_0_reset_n_reset_bridge_in_reset_reset),              //  clk_reset.reset
	...
	elc3_soc_mm_interconnect_0_cmd_mux cmd_mux (
		.clk                 (clk_0_clk_clk),                                    //       clk.clk
		.reset               (nios2_qsys_0_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	elc3_soc_mm_interconnect_0_cmd_mux cmd_mux_001 (
		.clk                 (clk_0_clk_clk),                                    //       clk.clk
		.reset               (nios2_qsys_0_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	elc3_soc_mm_interconnect_0_cmd_mux cmd_mux_002 (
		.clk                 (clk_0_clk_clk),                                    //       clk.clk
		.reset               (nios2_qsys_0_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	elc3_soc_mm_interconnect_0_cmd_mux cmd_mux_003 (
		.clk                 (clk_0_clk_clk),                                    //       clk.clk
		.reset               (nios2_qsys_0_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	elc3_soc_mm_interconnect_0_cmd_mux cmd_mux_004 (
		.clk                 (sdram_pll_c0_clk),                                   //       clk.clk
		.reset               (sdram_controller_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	elc3_soc_mm_interconnect_0_cmd_mux cmd_mux_005 (
		.clk                 (clk_0_clk_clk),                                    //       clk.clk
		.reset               (nios2_qsys_0_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	elc3_soc_mm_interconnect_0_rsp_demux rsp_demux (
		.clk                (clk_0_clk_clk),                                    //       clk.clk
		.reset              (nios2_qsys_0_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	elc3_soc_mm_interconnect_0_rsp_demux rsp_demux_001 (
		.clk                (clk_0_clk_clk),                                    //       clk.clk
		.reset              (nios2_qsys_0_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	elc3_soc_mm_interconnect_0_rsp_demux rsp_demux_002 (
		.clk                (clk_0_clk_clk),                                    //       clk.clk
		.reset              (nios2_qsys_0_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	elc3_soc_mm_interconnect_0_rsp_demux rsp_demux_003 (
		.clk                (clk_0_clk_clk),                                    //       clk.clk
		.reset              (nios2_qsys_0_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	elc3_soc_mm_interconnect_0_rsp_demux rsp_demux_004 (
		.clk                (sdram_pll_c0_clk),                                   //       clk.clk
		.reset              (sdram_controller_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	elc3_soc_mm_interconnect_0_rsp_demux rsp_demux_005 (
		.clk                (clk_0_clk_clk),                                      //       clk.clk
		.reset              (nios2_qsys_0_reset_n_reset_bridge_in_reset_reset),   // clk_reset.reset
		.sink_ready         (char_buffer_s1_rsp_width_adapter_src_ready),         //      sink.ready
		.sink_channel       (char_buffer_s1_rsp_width_adapter_src_channel),       //          .channel
		.sink_data          (char_buffer_s1_rsp_width_adapter_src_data),          //          .data
		.sink_startofpacket (char_buffer_s1_rsp_width_adapter_src_startofpacket), //          .startofpacket
		.sink_endofpacket   (char_buffer_s1_rsp_width_adapter_src_endofpacket),   //          .endofpacket
		.sink_valid         (char_buffer_s1_rsp_width_adapter_src_valid),         //          .valid
	...
	elc3_soc_mm_interconnect_0_rsp_mux rsp_mux (
		.clk                 (clk_0_clk_clk),                                    //       clk.clk
		.reset               (nios2_qsys_0_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	elc3_soc_mm_interconnect_0_rsp_mux rsp_mux_001 (
		.clk                 (clk_0_clk_clk),                                    //       clk.clk
		.reset               (nios2_qsys_0_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	altera_merlin_width_adapter #(
	...
	) char_buffer_s1_rsp_width_adapter (
		.clk                  (clk_0_clk_clk),                                      //       clk.clk
		.reset                (nios2_qsys_0_reset_n_reset_bridge_in_reset_reset),   // clk_reset.reset
		...
		.out_endofpacket      (char_buffer_s1_rsp_width_adapter_src_endofpacket),   //       src.endofpacket
		.out_data             (char_buffer_s1_rsp_width_adapter_src_data),          //          .data
		.out_channel          (char_buffer_s1_rsp_width_adapter_src_channel),       //          .channel
		.out_valid            (char_buffer_s1_rsp_width_adapter_src_valid),         //          .valid
		.out_ready            (char_buffer_s1_rsp_width_adapter_src_ready),         //          .ready
		.out_startofpacket    (char_buffer_s1_rsp_width_adapter_src_startofpacket), //          .startofpacket
	...
	altera_merlin_width_adapter #(
		...
		.PACKING                       (1),
		.ENABLE_ADDRESS_ALIGNMENT      (0)
	) char_buffer_s1_cmd_width_adapter (
		.clk                  (clk_0_clk_clk),                                      //       clk.clk
		.reset                (nios2_qsys_0_reset_n_reset_bridge_in_reset_reset),   // clk_reset.reset
		...
		.out_endofpacket      (char_buffer_s1_cmd_width_adapter_src_endofpacket),   //       src.endofpacket
		.out_data             (char_buffer_s1_cmd_width_adapter_src_data),          //          .data
		.out_channel          (char_buffer_s1_cmd_width_adapter_src_channel),       //          .channel
		.out_valid            (char_buffer_s1_cmd_width_adapter_src_valid),         //          .valid
		.out_ready            (char_buffer_s1_cmd_width_adapter_src_ready),         //          .ready
		.out_startofpacket    (char_buffer_s1_cmd_width_adapter_src_startofpacket), //          .startofpacket
		.in_command_size_data (3'b000)                                              // (terminated)
	);
	...
	elc3_soc_mm_interconnect_0_avalon_st_adapter #(
		.inBitsPerSymbol (34),
		.inUsePackets    (0),
		.inDataWidth     (34),
		.inChannelWidth  (0),
	...
	elc3_soc_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_clk_0_clk   (clk_0_clk_clk),                                    // in_clk_0.clk
		.in_rst_0_reset (nios2_qsys_0_reset_n_reset_bridge_in_reset_reset), // in_rst_0.reset
		.in_0_data      (nios_onchipmem_s1_agent_rdata_fifo_src_data),      //     in_0.data
		.in_0_valid     (nios_onchipmem_s1_agent_rdata_fifo_src_valid),     //         .valid
		.in_0_ready     (nios_onchipmem_s1_agent_rdata_fifo_src_ready),     //         .ready
	...
	elc3_soc_mm_interconnect_0_avalon_st_adapter_005 #(
		.inBitsPerSymbol (10),
		.inUsePackets    (0),
		.inDataWidth     (10),
		.inChannelWidth  (0),
		...
		.in_clk_0_clk   (clk_0_clk_clk),                                    // in_clk_0.clk
		.in_rst_0_reset (nios2_qsys_0_reset_n_reset_bridge_in_reset_reset), // in_rst_0.reset
		.in_0_data      (char_buffer_s1_agent_rdata_fifo_src_data),         //     in_0.data
		.in_0_valid     (char_buffer_s1_agent_rdata_fifo_src_valid),        //         .valid
		.in_0_ready     (char_buffer_s1_agent_rdata_fifo_src_ready),        //         .ready
